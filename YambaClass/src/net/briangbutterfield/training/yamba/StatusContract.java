...
public final class StatusContract 
{
	...
	public static final String AUTHORITY = "net.briangbutterfield.training.yamba.provider";
    ...
    public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.innovsys.status";

    /** The MIME type of a {@link #CONTENT_URI} a single status message. */
    public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.innovsys.status";
