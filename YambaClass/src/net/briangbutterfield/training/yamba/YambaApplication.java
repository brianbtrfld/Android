...
public class YambaApplication extends Application implements OnSharedPreferenceChangeListener
{
    ...
    public static final String ACTION_NEW_STATUS = "net.briangbutterfield.training.yamba.ACTION_NEW_STATUS";
    public static final String EXTRA_NEW_STATUS_COUNT = "EXTRA_NEW_STATUS_COUNT";
    public static final String PERM_NEW_STATUS = "net.briangbutterfield.training.yamba.permission.permission.NEW_STATUS";
